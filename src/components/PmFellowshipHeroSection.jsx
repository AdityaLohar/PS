...
const PmFellowshipHeroSection = () => {
  ...
  return (
    <div
      className="bg-transparent md:px-10 xl:px-48 py-0 md:py-8 lg:py-20 font-hind"
      style={{
    ...
    >
      <div className="bg-white relative flex flex-col lg:flex-row py-4 lg:py-8 items-center justify-between gap-6 md:gap-8 lg:gap-12 lg:border border-1 border-[#00B5CE] rounded-[24px] md:rounded-[32px] px-4 lg:px-8">
        <div className="flex flex-col gap-4 lg:gap-6 w-full lg:w-[57%]">
          ...
          <div className="text-[16px] flex flex-col gap-4 md:gap-0 md:flex-row bg-[#D7F5FF] rounded-xl p-3">
